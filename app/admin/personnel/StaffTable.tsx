    ...
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button 
          ...
          className="inline-flex items-center gap-2 rounded-md bg-[#1D3F75] px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#1D3F75] transition-colors"
        >
                  ...
                  <tr key={member.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className={`inline-flex items-center rounded-full px-2.5 py-1 text-xs font-medium ${
                        member.status === "active" ? "bg-blue-50 text-green-700 ring-1 ring-inset ring-green-600/20" : "bg-gray-50 text-gray-600 ring-1 ring-inset ring-gray-500/10"
                      }`}>
                    ...
                    <td className="px-6 py-4 text-right">
                      <button 
                        ...
                        className="inline-flex items-center gap-1.5 text-[#1D3F75] hover:text-[#112A54] font-medium text-xs px-3 py-1.5 rounded hover:bg-[#1D3F75]/10 transition-colors"
                      >
          ...
          <div className="bg-white border border-gray-200 w-full max-w-lg rounded-2xl shadow-xl overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center gap-4 mt-2">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input type="radio" name="status" value="active" checked={formData.status === "active"} onChange={() => setFormData({...formData, status: "active"})} className="text-[#1D3F75] focus:ring-[#1D3F75]" />
                    <span className="text-sm">Actif</span>
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input type="radio" name="status" value="inactive" checked={formData.status === "inactive"} onChange={() => setFormData({...formData, status: "inactive"})} className="text-[#1D3F75] focus:ring-[#1D3F75]" />
              ...
              <div className="pt-4 flex justify-end gap-3 border-t">
                ...
                <Button type="submit" disabled={loading} className="bg-[#1D3F75] hover:bg-[#1D3F75] text-white">
