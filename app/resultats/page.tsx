  ...
  return (
    <div className="mx-auto max-w-3xl">
      <div className="text-center mb-10">
        <h1 className="text-3xl font-bold text-[#1D3F75] font-heading">Portail Patient</h1>
      ...
      {!data ? (
        <div className="mx-auto max-w-md rounded-2xl border bg-white p-6 shadow-xl">
          <div className="mb-6 flex justify-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#1D3F75]/10 text-[#1D3F75]">
          ...
          <form onSubmit={handleSearch} className="space-y-6">
            ...
            <Button type="submit" disabled={loading} className="w-full bg-[#1D3F75] text-white hover:bg-[#112A54] py-6 text-lg rounded-xl">
                ...
                data.results.map((res: any) => (
                  <div key={res.id} className="flex items-center justify-between p-6 hover:bg-gray-50/50 transition-colors">
                    <div className="flex items-center gap-4">
                      <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-[#1D3F75]/10 text-[#1D3F75]">
                    ...
                    <a href={res.resultUrl} target="_blank" rel="noopener noreferrer">
                      <Button variant="outline" className="gap-2 text-[#1D3F75] border-[#1D3F75]/20 hover:bg-[#1D3F75]/5">
