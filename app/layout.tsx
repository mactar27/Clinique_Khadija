...
export const metadata: Metadata = {
  title: "Clinique Khadija — Votre santé, notre priorité au quotidien",
  description:
    "La Clinique Khadija à la ZAC Mbao propose des consultations, spécialistes, urgences 24/7, hospitalisation, imagerie et laboratoire. Prenez rendez-vous en ligne.",
  generator: "v0.app",
  openGraph: {
