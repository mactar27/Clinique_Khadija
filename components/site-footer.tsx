...
export function SiteFooter() {
  ...
  return (
    <footer className="bg-[#0A1C3A] text-blue-50/80 mt-16 rounded-t-[2.5rem]">
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 md:grid-cols-3">
        <div className="space-y-4">
          ...
          <p className="max-w-xs text-sm leading-relaxed text-blue-100/80">{t("footerTagline")}</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-4 text-sm text-blue-100/80">
            <li className="flex items-start gap-3">
              <span className="flex size-8 shrink-0 items-center justify-center rounded-lg bg-white/10 text-blue-300">
            ...
            <li className="flex items-center gap-3">
              ...
              <a href="tel:+221774698181" className="hover:text-white transition-colors font-medium">
                {t("call")}
              </a>
            </li>
          </ul>
      ...
      <div className="border-t border-blue-800/50">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-6 py-6 text-xs text-blue-200/60 md:flex-row">
          <div>
            {"© "}
          ...
          <div>
            ...
            <a
              ...
              className="font-medium text-blue-100 hover:text-white hover:underline transition-colors"
            >
              WockyTech
            </a>
          </div>
