      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-heading text-4xl font-extrabold text-[#1a1a1a]">
            Nos <span className="text-[#1D3F75]">spécialités</span>
          </h2>
          
          <div className="flex items-center justify-center gap-3 my-4">
            <div className="h-px w-12 bg-border/80"></div>
            <Heart className="size-4 text-[#1D3F75]" strokeWidth={2} />
            <div className="h-px w-12 bg-border/80"></div>
          </div>
          ...
          {specialties.slice(0, 12).map((s) => {
            ...
            return (
              <li key={s.slug} className="w-[80vw] max-w-[300px] shrink-0 snap-center sm:w-auto sm:max-w-none">
                <div className="group flex h-full flex-col items-center text-center gap-4 rounded-3xl border border-border/40 bg-white p-6 shadow-sm transition-all duration-300 hover:border-blue-100 hover:shadow-lg hover:-translate-y-1">
                  <div className="flex size-16 shrink-0 items-center justify-center rounded-full bg-blue-50 text-[#1D3F75]">
                  ...
                  <div className="mb-2">
                    ...
                    <p className="text-xs text-muted-foreground mt-1 px-4">{s.fr} de la CLINIQUE Khadija</p>
                  </div>
                  
                  <div className="mt-auto pt-2 w-full">
                    <Button render={<Link href={`/reservation?specialty=${s.slug}`} />} className="w-[90%] mx-auto flex gap-2 bg-[#1D3F75] text-white hover:bg-[#112A54] rounded-xl shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105">
        ...
        {/* Bottom Banner */}
        <div className="mt-12 w-full rounded-3xl bg-blue-50/50 border border-blue-100 p-4 lg:p-6 shadow-sm transition-all hover:shadow-md">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-10">
            
            {/* Left Box */}
            <div className="flex items-center gap-4 bg-white p-4 rounded-2xl shadow-sm border border-border/40 w-full lg:w-auto transition-all duration-300 hover:shadow-md">
              <div className="flex size-12 shrink-0 items-center justify-center rounded-xl bg-[#1D3F75] text-white">
            ...
            <div className="flex flex-col items-center lg:items-end w-full lg:w-auto">
              <Button render={<Link href="/reservation" />} className="w-full lg:w-auto gap-2 bg-[#1D3F75] text-white hover:bg-[#112A54] rounded-xl px-6 shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105">
                <CalendarPlus className="size-4" />
                Prendre rendez-vous
              </Button>
              <p className="text-xs text-muted-foreground mt-2">
                Ou appelez : <a href="tel:+221774698181" className="font-bold text-foreground">+221 77 469 81 81</a>
              </p>
            </div>
