        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-4 flex flex-col">
            <div className="w-fit mb-4">
              <span className="inline-flex items-center gap-2 rounded-full bg-blue-50 px-4 py-1.5 text-sm font-bold text-[#1D3F75]">
            ...
            <h2 className="font-heading text-3xl md:text-4xl font-extrabold text-[#1a1a1a] leading-[1.2] mb-6">
              Présentation de <span className="text-[#1D3F75]">l'établissement</span>
            </h2>
            
            <p className="text-slate-600 leading-relaxed mb-8 text-sm md:text-base">
              La Clinique Khadija s'engage à offrir des soins de qualité, dans un environnement moderne et sécurisé. Notre équipe médicale qualifiée met l'humain au cœur de chaque prise en charge.
            </p>
            ...
            <div className="flex flex-col sm:flex-row lg:flex-col xl:flex-row gap-4 mt-auto">
              <div className="flex-1 rounded-xl border border-slate-200 bg-white p-4 flex items-center gap-3 shadow-sm">
                <div className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-blue-50 text-[#1D3F75]">
          ...
          <div className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="rounded-2xl bg-blue-50/40 p-6 flex flex-col border border-blue-100/60 shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-1">
              <div className="flex items-center gap-4 mb-4">
                <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#1D3F75] text-white shadow-sm">
            ...
            <div className="rounded-2xl bg-blue-50/40 p-6 flex flex-col border border-blue-100/60 shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-1">
              ...
              <p className="text-xs text-slate-600 leading-relaxed mb-4">Cité Inter-Promo, ZAC Mbao, Dakar.</p>
              <Link href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="text-xs font-bold text-[#1D3F75] hover:underline flex items-center gap-1 mt-auto w-fit">
          ...
          {/* Right Column (3/12) */}
          <div id="services" className="lg:col-span-3 flex flex-col scroll-mt-24">
            <h3 className="font-bold text-slate-900 mb-4">Nos services</h3>
            <div className="flex flex-col gap-2">
              {servicesList.map((service, index) => (
                <Link key={index} href={service.href} className="group flex items-center gap-4 rounded-xl bg-slate-50 p-3 hover:bg-white hover:shadow-md transition-all duration-300 cursor-pointer border border-transparent hover:border-blue-100">
                  <div className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-blue-50 text-[#1D3F75]">
                    <service.icon className="size-5 transition-transform duration-300 group-hover:scale-110" strokeWidth={1.5} />
                  </div>
                  ...
                  <ChevronRight className="size-4 text-slate-400 transition-transform duration-300 group-hover:translate-x-1" />
                </Link>
              ))}
            </div>
          </div>
