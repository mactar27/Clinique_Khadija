...
export function BookingFlow() {
  ...
  if (done) {
    return (
      <div className="mx-auto max-w-lg rounded-[2.5rem] border border-border/40 bg-white p-10 text-center shadow-lg">
        <div className="mx-auto flex size-20 items-center justify-center rounded-full bg-blue-50 text-[#1D3F75]">
        ...
        <div className="mt-6 rounded-2xl bg-blue-50 p-5 border border-green-100">
          <p className="text-sm font-semibold text-[#1D3F75]">
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
          ...
          <Button asChild className="rounded-xl py-6 bg-[#1D3F75] text-white hover:bg-[#112A54] font-semibold shadow-md">
  ...
  return (
    <div className="mx-auto max-w-2xl">
              ...
              <div className="flex items-center gap-2">
                <span
                  className={cn(
                    ...
                    active && "border-[#1D3F75] bg-[#1D3F75] text-white",
                    complete && "border-[#1D3F75] bg-blue-50 text-[#1D3F75]",
      ...
      <div className="rounded-[2.5rem] border border-border/40 bg-white p-8 shadow-xl shadow-blue-900/5 sm:p-10">
        ...
        {step === 1 && (
          <div className="flex flex-col gap-6">
            ...
            {(!preselected || !specialtySlug) ? (
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        specialtySlug === s.slug
                          ? "border-[#1D3F75] bg-blue-50/50 shadow-sm scale-[1.02]"
                          : "border-border/40 bg-white hover:border-[#1D3F75]/30 hover:bg-slate-50",
                      )}
                      aria-pressed={specialtySlug === s.slug}
                    >
                      <div className={cn(
                        "flex size-12 items-center justify-center rounded-full transition-colors",
                        specialtySlug === s.slug ? "bg-[#1D3F75] text-white" : "bg-blue-50 text-[#1D3F75]"
                      )}>
              ...
              specialty && (
                <div className="flex w-full items-center gap-4 rounded-2xl border-2 border-[#1D3F75] bg-blue-50/50 p-4 text-left shadow-sm">
                  <div className="flex size-12 items-center justify-center rounded-full bg-[#1D3F75] text-white">
                    <Stethoscope className="size-6" strokeWidth={1.5} aria-hidden="true" />
                  </div>
                  <div>
                    <span className="block text-base font-bold text-foreground">
                    ...
                    <Link href="/reservation" onClick={() => { setSpecialtySlug(""); setReason(""); }} className="block text-sm text-[#1D3F75] hover:underline mt-0.5">
            ...
            <div className="flex justify-end mt-6">
              <Button onClick={goNext} disabled={!canNextFromStep1} className="gap-2 rounded-xl py-6 px-8 bg-[#1D3F75] text-white hover:bg-[#112A54] font-semibold shadow-md">
                {t("next")}
        ...
        {step === 2 && specialty && (
          <div className="flex flex-col gap-6">
            <div className="flex items-start gap-4 rounded-2xl border border-border/40 bg-blue-50/30 p-5">
            ...
            <div className="flex justify-between mt-6">
              ...
              <Button onClick={goNext} disabled={!canNextFromStep2} className="gap-2 rounded-xl py-6 px-8 bg-[#1D3F75] text-white hover:bg-[#112A54] font-semibold shadow-md">
                {t("next")}
                <ChevronRight className="size-5" aria-hidden="true" />
              </Button>
            </div>
        ...
        {step === 3 && specialty && (
          <div className="flex flex-col gap-6">
            ...
            {/* Summary */}
            <div className="rounded-2xl border border-border/40 bg-blue-50/30 p-6">
            ...
            <div className="flex justify-between mt-6">
              ...
              <Button onClick={handleSubmit} disabled={!canSubmit || pending} className="gap-2 rounded-xl py-6 px-8 bg-[#1D3F75] text-white hover:bg-[#112A54] font-semibold shadow-md">
                {pending ? (
                  <>
